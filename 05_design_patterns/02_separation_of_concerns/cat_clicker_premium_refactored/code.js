...
var controller = {
  ...
  attachEventToList: function(cat) {
    var activeCatIndex = data["activeCatIndex"];
    if (activeCatIndex != null) {
      viewCatImages.removeCat(data["cats"][activeCatIndex]);
  }
  ...
  createListCats: function(){
    ...
    for (var i=0; i<cats.length; i++) {
      ...
      elem.addEventListener('click', (function(cat) {
        return controller.attachEventToList.bind(null, cat);
      })(catName));
